...
import { getRides, getRideStats, type RideWithRelations, type RideStatus } from '@/lib/actions/rides-v2';
                ...
                <Card className="hover:shadow-md transition-all">
                  <div className="flex items-center justify-between p-5">
                    <div className="flex items-center gap-5 flex-1">
                      <div className="text-2xl font-bold text-blue-600 tabular-nums min-w-[64px]">
                        {new Date(ride.pickupTime).toLocaleTimeString('de-CH', {
                          hour: '2-digit',
                          minute: '2-digit',
                        })}
